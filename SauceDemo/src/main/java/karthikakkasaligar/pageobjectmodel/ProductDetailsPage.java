...
public class ProductDetailsPage extends ReUseableComponents {
	...
	public void Detailedproductdetails(String expectedName, String expectedDescription, String expectedPrice) {
		...
		Assert.assertEquals(ProductDetails.findElement(productname).getText().trim(), expectedName,
				"Product name mismatch");
		Assert.assertEquals(ProductDetails.findElement(Description).getText().trim(), expectedDescription,
				"Product description mismatch");
		Assert.assertEquals(ProductDetails.findElement(Price).getText().trim(), expectedPrice,
