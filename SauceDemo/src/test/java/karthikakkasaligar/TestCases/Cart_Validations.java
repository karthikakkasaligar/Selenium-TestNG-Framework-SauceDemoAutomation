...
public class Cart_Validations extends BaseTest {
	...
	{
		String[] productslist = {"Sauce Labs Backpack", "Sauce Labs Fleece Jacket", "Sauce Labs Onesie","Sauce Labs Bike Light","Sauce Labs Bolt T-Shirt","Test.allTheThings() T-Shirt (Red)"};
		inventoryPage inventory = login.login(login.getusername(), login.getpassword());
